...
export default function CenterSection() {
  return (
    <Section>
      ...
      <IdentityBand />
      <Photos>
        <PhotoFigure src="/images/img09.png" caption="럼동농아학교" aspect="3 / 2" maxHeight="222px" />
        <PhotoFigure src="/images/img13.png" caption="장애인 초콜릿 카페" aspect="3 / 2" maxHeight="222px" />
        <PhotoFigure src="/images/img08.png" caption="장애직업지도-멕셀플라워만들기" aspect="3 / 2" maxHeight="222px" />
        <PhotoFigure src="/images/img12.png" caption="특수 교사 양성" aspect="3 / 2" maxHeight="222px" />
      </Photos>
      <Ministries>
        {ministries.map((m) => (
